  ...
  return (
    <section className="w-full px-4 md:px-8 bg-[#E7E7E3] font-rubik">
      ...
      <Container className="py-2 pb-4 md:py-20 text-center md:text-left ">
        <h1 className="text-6xl md:text-[223.5px] font-bold leading-[0.9] tracking-tighter uppercase animate-fade-in-up">
      ...
      <Container className="relative group">
        <div className=" relative w-full  md:max-w-none h-[382px] md:h-[800px] rounded-[24px] md:rounded-[64px] overflow-hidden    bg-[#E7E7E3] animate-scale-in">
          {/* Tag */}
          ...
          <div className="absolute bottom-8 left-8 md:bottom-16 md:left-16 ">
            <h2 className="text-2xl md:text-[74px] font-bold text-white uppercase  mb-1.5 md:mb-4 animate-fade-in-up delay-200">
              Nike Air Max
            </h2>
            <p className="text-white/90 text-sm md:text-2xl font-open-sans mb-2 md:mb-6 max-w-[200px] md:max-w-md animate-fade-in-up delay-300">
              Nike introducing the new air max for everyone's comfort
            </p>
            <Link href="/" className="cursor-pointer">
              <button className="bg-[#437EF7] font-inter cursor-pointer text-white px-4 py-1.5 md:px-8 md:py-4 rounded-lg  font-semibold md:font-bold uppercase hover:bg-blue-700 transition-all hover:scale-105 animate-fade-in-up delay-400">
                Shop Now
              </button>
            </Link>
          </div>
